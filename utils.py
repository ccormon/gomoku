...
def create_pattern_dict():
	...
	for player in (1, 2):
		...
		pattern_dict[(player,)*5] = 1_000_000 * sign

		pattern_dict[(EMPTY, player, player, player, player, EMPTY)] = 100_000 * sign
		pattern_dict[(EMPTY, player, player, player, EMPTY, player, EMPTY)] = 100_000 * sign
		pattern_dict[(EMPTY, player, EMPTY, player, player, player, EMPTY)] = 100_000 * sign
		pattern_dict[(EMPTY, player, player, EMPTY, player, player, EMPTY)] = 100_000 * sign
